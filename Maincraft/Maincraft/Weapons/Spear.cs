...
namespace Maincraft.Weapons
{
    public class Spear : Weapons
    {
        ...
        public Spear(Item stone, Item stick1, Item stick2) : base(
            damage: (stone.Damage + stick1.Damage + stick2.Damage) * 1.2,   
            attackSpeed: (stick1.AttackSpeed + stick2.AttackSpeed) / 2)
        {
            _stone = stone;
            _stick1 = stick1;
            _stick2 = stick2;
